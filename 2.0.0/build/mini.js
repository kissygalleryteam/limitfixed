...
kg/limitfixed/2.0.0/index
kg/limitfixed/2.0.0/mini
 ...
 *
 */
KISSY.add('kg/limitfixed/2.0.0/index',function (S, Event, Node, undefined) {
    var $ = Node.all,
        $$ = Node.one,
        UA = S.UA;
 ...
 * @module limitfixed
 **/
KISSY.add('kg/limitfixed/2.0.0/mini',function(S, Component) {
